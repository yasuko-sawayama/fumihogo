          ...
          <div className="infobox-content">
            <div className="infobox-content-avatars">
              ...
              <ul>
                <li>
                  <span
                    style={{ backgroundImage: "url(/img/tmp/user-1.jpg)" }}
                  />
                </li>

                <li>
                  <span
                    style={{ backgroundImage: "url(/img/tmp/user-2.jpg)" }}
                  />
                </li>

                <li>
                  <span
                    style={{ backgroundImage: "url(/img/tmp/user-3.jpg)" }}
                  />
                </li>

                <li>
                  <span
                    style={{ backgroundImage: "url(/img/tmp/user-4.jpg)" }}
                  />
                </li>

                <li>
                  <span
                    style={{ backgroundImage: "url(/img/tmp/user-5.jpg)" }}
                  />
                </li>
              </ul>
            </div>
